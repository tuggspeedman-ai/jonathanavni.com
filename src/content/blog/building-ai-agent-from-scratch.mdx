...
I've recently built [KuchiClaw](https://github.com/jonathanavni/kuchiclaw) - a minimal AI agent framework that runs 24/7 on a VPS, talks to me through Telegram, manages its own memory, sends emails, and runs scheduled tasks autonomously. About 2,000 lines of TypeScript, 15 files.
...
KuchiClaw is [open source on GitHub](https://github.com/jonathanavni/kuchiclaw). It's designed to be forked, read, and modified - not installed as a dependency. If you're building in this space or thinking about agent architectures, I'd love to connect.
